...
def xKV_qwen2_sdpa_forward(
    ...
    **kwargs,
    ...
    assert not output_attentions, "xKVQwen2 does not support output_attentions"
...
def enable_qwen_xKV_eval(
    ...
    for idx, layer in enumerate(model.model.layers):
        ...
        if not isinstance(module, Qwen2SdpaAttention):
            raise ValueError("We only support SdpaAttention for now.")
        
        module.forward = types.MethodType(
            xKV_qwen2_sdpa_forward, module
        )